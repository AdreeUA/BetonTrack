...
(function () {
    ...
    jQuery(function ($) {
        ...
        //     if (link.has(e.target).length === 0 && burger.has(e.target).length === 0 && !burger.is(e.target)) {
...
//     }
//
//     var popupCall = $("#popup-call").validate(optionValidationForm);
//     var popupConsultation = $("#popup-consultation").validate(optionValidationForm);
//     var popupRent = $("#popup-rent").validate(optionValidationForm);
//     var statementForm = $("#statement-form").validate(optionValidationForm);
//     var mapForm = $(".map__form").validate(optionValidationForm);
//
//     popupCall.form();
//
// });
